...
export async function run(extern_func) {  
  mergesort = extern_func;
    ...
    let times = [[],[],[],[],[],[]];
    let values100 = await readFile("http://localhost:3000/input/100.txt");
    let values250 = await readFile("http://localhost:3000/input/250.txt");
    let values500 = await readFile("http://localhost:3000/input/500.txt");
    let values1000 = await readFile("http://localhost:3000/input/1000.txt");
    let values5000 = await readFile("http://localhost:3000/input/5000.txt");
    let values10000 = await readFile("http://localhost:3000/input/10000.txt");
    for (let i = 0; i < 5; i++) {
      console.log(i)
      // xs
